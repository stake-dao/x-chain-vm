        ...
        )
    {
        ...
        unchecked {
            ...
            userSlope.slope = Verifier.extractSlotValueFromProof(
                keccak256(
                    abi.encode(uint256(keccak256(abi.encode(keccak256(abi.encode(1000000008, _user)), _gauge))) + 0)
                ),
                stateRootHash,
                proofs[4].toList()
            ).value;
            ...
            userSlope.power = Verifier.extractSlotValueFromProof(
                keccak256(
                    abi.encode(uint256(keccak256(abi.encode(keccak256(abi.encode(1000000008, _user)), _gauge))) + 1)
                ),
                stateRootHash,
                proofs[5].toList()
            ).value;
            ...
            userSlope.end = Verifier.extractSlotValueFromProof(
                keccak256(
                    abi.encode(uint256(keccak256(abi.encode(keccak256(abi.encode(1000000008, _user)), _gauge))) + 2)
                ),
                stateRootHash,
                proofs[6].toList()
            ).value;
            ...
            if (weight.bias == 0) {
                ...
                weight.bias = Verifier.extractSlotValueFromProof(
                    keccak256(
                        abi.encode(uint256(keccak256(abi.encode(keccak256(abi.encode(1000000011, _gauge)), time))) + 0)
                    ),
                    stateRootHash,
                    proofs[2].toList()
                ).value;
                ...
                weight.slope = Verifier.extractSlotValueFromProof(
                    keccak256(
                        abi.encode(uint256(keccak256(abi.encode(keccak256(abi.encode(1000000011, _gauge)), time))) + 1)
                    ),
                    stateRootHash,
                    proofs[3].toList()
                ).value;
