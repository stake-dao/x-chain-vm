...
import {FraxGaugeControllerOracle} from "src/frax/FraxGaugeControllerOracle.sol";
...
contract DeploySideChains is Script, Utils {
    ...
    Platform platform;
    FraxGaugeControllerOracle oracle;
    ...
    function run() public {
        ...
        oracle = new FraxGaugeControllerOracle(address(0));
